...
ActiveRecord::Schema.define(:version => 20120322091552) do
  ...
  create_table "participation_messages", :force => true do |t|
    t.text     "message"
  ...
  add_index "participation_messages", ["cbo_id"], :name => "index_participation_messages_on_cbo_id"
  add_index "participation_messages", ["participation_id"], :name => "index_participation_messages_on_participation_id"
  add_index "participation_messages", ["user_id"], :name => "index_participation_messages_on_user_id"
