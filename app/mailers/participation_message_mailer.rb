class ParticipationMessageMailer < ActionMailer::Base
  ...
  def new_message_from_user(participation_message)
    ...
    @user = participation_message.user
    @participation_message = participation_message
    @url = "http://#{request.host_with_por}" + participation_path(participation_message.participation) #request.url #request.host_with_port + participation_path(participation_message.participation)
